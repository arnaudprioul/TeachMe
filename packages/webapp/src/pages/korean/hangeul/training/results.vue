  ...
  <div class="results page-container" :style="{ '--color-course': course.color }">
    <template v-if="training.session">
      ...
      <div class="results__actions">
        <button class="btn btn--primary btn--full" @click="training.start(); navigateTo('/korean/hangeul/training/play')">
          {{ t('training.tryAgain') }}
        </button>
        <NuxtLink to="/korean/hangeul/training" class="btn btn--ghost btn--full">
