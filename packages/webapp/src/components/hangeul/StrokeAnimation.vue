...
import { HANGEUL_STROKES } from '~/composables/data/hangeulStrokes'

const props = defineProps<{ charId: string }>()

// Static SVGs from hangeul-stroke-order project (display with numbers + arrows)
...
const strokeData = computed(() => HANGEUL_STROKES[props.charId])
...
.sa__fallback span {
  font-family: var(--font-cjk-kr); font-size: 8rem;
